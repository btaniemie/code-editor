...
public class GeminiClient {
    ...
    private String buildReviewPrompt(String document, String language) {
        return "You are a code reviewer. Review the following " + language + " code.\n"
            ...
            + "  \"fix\":      string or null — the complete corrected replacement text for\n"
            + "               that single line, preserving the original indentation style;\n"
            + "               null only when the issue requires changing more than one line\n\n"
